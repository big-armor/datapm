...
export const CURRENT_PACKAGE_FILE_SCHEMA_URL = "https://datapm.io/docs/package-file-schema-v0.32.1.json";
...
export interface Source {
    ...
    /** Used only by the update comand, and not used in fetch command. This allows updates to happen using a preset configuration
     * but fetch to request configurations from the user.
     */
    updateConfiguration?: DPMConfiguration;
