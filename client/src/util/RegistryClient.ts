...
import { getRegistryConfig, RegistryConfig } from "./ConfigUtil";
...
export function getRegistryClientWithConfig(registryRef: { url: string }): RegistryClient {
	const registryConfig = getRegistryConfig(registryRef.url);
