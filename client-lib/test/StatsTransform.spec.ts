...
describe("Stats transform", () => {
    ...
    test("Test objects", async () => {
        ...
        const firstInteger = statsTransform.schemas.test.properties?.testObject?.properties?.integer;
        ...
        const firstNumber = statsTransform.schemas.test.properties?.testObject?.properties?.number;
        ...
        const firstString = statsTransform.schemas.test.properties?.testObject?.properties?.string;
        ...
        const secondInteger =
            statsTransform.schemas.test.properties?.testObject?.properties?.testSubObject.properties?.integer;
        ...
        const secondNumber =
            statsTransform.schemas.test.properties?.testObject?.properties?.testSubObject.properties?.number;
        ...
        const secondBoolean =
            statsTransform.schemas.test.properties?.testObject?.properties?.testSubObject.properties?.boolean;
    ...
    test("Test content lables on objects", async () => {
        ...
        const latitudeProperty = statsTransform.schemas.test.properties?.testObject?.properties?.latitude;
        ...
        const longitudeProperty = statsTransform.schemas.test.properties?.testObject?.properties?.longitude;
