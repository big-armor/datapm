...
export class AddExtraNotificationFieldsToFollowEntity1624904654313 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        return queryRunner.query(`
            ...
            ALTER TABLE "follow" ADD COLUMN follow_package_issues BOOLEAN DEFAULT FALSE;
            ALTER TABLE "follow" ADD COLUMN change_type activity_log_change_type_enum DEFAULT {};
